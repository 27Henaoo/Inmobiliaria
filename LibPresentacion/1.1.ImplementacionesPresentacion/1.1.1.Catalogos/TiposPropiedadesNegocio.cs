...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._1.Catalogos
{
    public class TiposPropiedadesNegocio : ITiposPropiedadesNegocio
    {
        ...
        public List<TiposPropiedades> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/TiposPropiedades/Consultar";
            datos["Metodo"] = "GET";
        ...
        public TiposPropiedades Guardar(TiposPropiedades entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/TiposPropiedades/Guardar";
            datos["Metodo"] = "POST";
        ...
        public TiposPropiedades Modificar(TiposPropiedades entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/TiposPropiedades/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public TiposPropiedades Borrar(TiposPropiedades entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/TiposPropiedades/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
