...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._3.RRHH
{
    public class ExpedientesLaboralesNegocio : IExpedientesLaboralesNegocio
    {
        ...
        public List<ExpedientesLaborales> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/ExpedientesLaborales/Consultar";
            datos["Metodo"] = "GET";
        ...
        public ExpedientesLaborales Guardar(ExpedientesLaborales entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ExpedientesLaborales/Guardar";
            datos["Metodo"] = "POST";
        ...
        public ExpedientesLaborales Modificar(ExpedientesLaborales entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ExpedientesLaborales/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public ExpedientesLaborales Borrar(ExpedientesLaborales entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ExpedientesLaborales/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
