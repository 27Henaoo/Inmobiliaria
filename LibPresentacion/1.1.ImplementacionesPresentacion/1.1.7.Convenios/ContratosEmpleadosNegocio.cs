...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._7.Convenios
{
    public class ContratosEmpleadosNegocio : IContratosEmpleadosNegocio
    {
        ...
        public List<ContratosEmpleados> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/ContratosEmpleados/Consultar";
            datos["Metodo"] = "GET";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new List<ContratosEmpleados>();

            // Se deserializa la respuesta y se devuelve.
            return JsonConvert.DeserializeObject<List<ContratosEmpleados>>(
        ...
        public ContratosEmpleados Guardar(ContratosEmpleados entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ContratosEmpleados/Guardar";
            datos["Metodo"] = "POST";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new ContratosEmpleados();

            // Se deserializa la respuesta y se devuelve.
            return JsonConvert.DeserializeObject<ContratosEmpleados>(
                respuesta["Valor"].ToString()!)!;
        }
        ...
        public ContratosEmpleados Modificar(ContratosEmpleados entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ContratosEmpleados/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public ContratosEmpleados Borrar(ContratosEmpleados entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ContratosEmpleados/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
