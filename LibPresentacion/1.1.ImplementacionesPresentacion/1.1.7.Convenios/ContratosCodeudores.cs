...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._7.Convenios
{
    public class ContratosCodeudoresNegocio : IContratosCodeudoresNegocio
    {
        ...
        public List<ContratosCodeudores> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/ContratosCodeudores/Consultar";
            datos["Metodo"] = "GET";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new List<ContratosCodeudores>();

            // Se deserializa la respuesta y se devuelve.
            return JsonConvert.DeserializeObject<List<ContratosCodeudores>>(
        ...
        public ContratosCodeudores Guardar(ContratosCodeudores entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ContratosCodeudores/Guardar";
            datos["Metodo"] = "POST";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new ContratosCodeudores();

            // Se deserializa la respuesta y se devuelve.
            return JsonConvert.DeserializeObject<ContratosCodeudores>(
                respuesta["Valor"].ToString()!)!;
        }
        ...
        public ContratosCodeudores Modificar(ContratosCodeudores entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ContratosCodeudores/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public ContratosCodeudores Borrar(ContratosCodeudores entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/ContratosCodeudores/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
