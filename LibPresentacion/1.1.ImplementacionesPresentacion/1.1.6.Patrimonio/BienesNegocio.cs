...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._6.Patrimonio
{
    public class BienesNegocio : IBienesNegocio
    {
        ...
        public List<Bienes> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/Bienes/Consultar";
            datos["Metodo"] = "GET";
        ...
        public Bienes Guardar(Bienes entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/Bienes/Guardar";
            datos["Metodo"] = "POST";
        ...
        public Bienes Modificar(Bienes entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/Bienes/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public Bienes Borrar(Bienes entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/Bienes/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
