...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._6.Patrimonio
{
    public class BienesInmueblesNegocio : IBienesInmueblesNegocio
    {
        ...
        public List<BienesInmuebles> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/BienesInmuebles/Consultar";
            datos["Metodo"] = "GET";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new List<BienesInmuebles>();

            // Se deserializa la respuesta y se devuelve.
            return JsonConvert.DeserializeObject<List<BienesInmuebles>>(
        ...
        public BienesInmuebles Guardar(BienesInmuebles entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/BienesInmuebles/Guardar";
            datos["Metodo"] = "POST";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new BienesInmuebles();

            // Se deserializa la respuesta y se devuelve.
            return JsonConvert.DeserializeObject<BienesInmuebles>(
                respuesta["Valor"].ToString()!)!;
        }
        ...
        public BienesInmuebles Modificar(BienesInmuebles entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/BienesInmuebles/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public BienesInmuebles Borrar(BienesInmuebles entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/BienesInmuebles/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
