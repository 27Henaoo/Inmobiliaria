...
namespace LibPresentacion._1._1.ImplementacionesPresentacion._1._1._4.Comercial
{
    public class CompradoresNegocio : ICompradoresNegocio
    {
        ...
        public List<Compradores> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7173/Compradores/Consultar";
            datos["Metodo"] = "GET";
        ...
        public Compradores Guardar(Compradores entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/Compradores/Guardar";
            datos["Metodo"] = "POST";
        ...
        public Compradores Modificar(Compradores entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/Compradores/Modificar";
            datos["Metodo"] = "PUT";
            datos["Entidad"] = entidad;
        ...
        public Compradores Borrar(Compradores entidad)
        {
            ...
            // Se crea el diccionario con los datos de la petición.
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7173/Compradores/Borrar";
            datos["Metodo"] = "DELETE";
            datos["Entidad"] = entidad;
