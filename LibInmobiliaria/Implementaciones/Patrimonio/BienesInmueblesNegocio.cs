...
namespace LibInmobiliaria.Implementaciones.Patrimonio
{
    ...
    {
        private string ObtenerDatosBienesInmuebles(BienesInmuebles entidad)
        {
            return $"Id: {entidad.Id}, " +
                   ...
                   $"EstadoConservacion: {entidad.EstadoConservacion}, " +
                   $"Estrato: {entidad.Estrato}, " +
                   $"NumeroHabitaciones: {entidad.NumeroHabitaciones}, " +
                   $"NumeroBanos: {entidad.NumeroBanos}, " +
                   $"CodigoCUC: {entidad.CodigoCUC}, " +
                   $"EncargosDeudas: {entidad.EncargosDeudas}, ";
        }
        ...
        public List<BienesInmuebles> Consultar()
        {
            ...
            try
            {
                // Se consultan los registros de BienesInmuebles en forma de lista.
                var lista = this.iConexion.BienesInmuebles!.Include(x => x._ExpedienteFinanciero!).ThenInclude(x => x._Persona).ToList();

                AgregarHistorico(
                    accion: "Consultar",
                    registroId: null,
                    descripcion: "Se consultaron los registros de BienesInmuebles",
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    accion: "Consultar",
                    registroId: null,
                    descripcion: "Fallo al consultar los registros de BienesInmuebles",
        ...
        public BienesInmuebles Guardar(BienesInmuebles entidad)
        {
            ...
            try
            {
                ...
                AgregarHistorico(
                    accion: "Guardar",
                    registroId: null,
                    descripcion: "Se guardo un nuevo registro de BienesInmuebles",
                    cambios: "Se creo un nuevo registro",
                    valorAnterior: null,
                    valorNuevo: ObtenerDatosBienesInmuebles(entidad),
                    exitoso: true,
                    error: "N/A"
                );
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    ...
                    descripcion: "Fallo al guardar un registro de BienesInmuebles",
        ...
        public BienesInmuebles Modificar(BienesInmuebles entidad)
        {
            ...
            try
            {
                ...
                var anterior = this.iConexion.BienesInmuebles!.FirstOrDefault(x => x.Id == entidad.Id);

                if (anterior == null)
                    throw new Exception("El registro de BienesInmuebles no existe");

                string valorAnterior = ObtenerDatosBienesInmuebles(anterior);
                string valorNuevo = ObtenerDatosBienesInmuebles(entidad);
                ...
                AgregarHistorico(
                    accion: "Modificar",
                    registroId: entidad.Id,
                    descripcion: "Se modifico un registro de BienesInmuebles",
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    accion: "Modificar",
                    registroId: entidad.Id,
                    descripcion: "Fallo al modificar un registro de BienesInmuebles",
        ...
        public BienesInmuebles Borrar(BienesInmuebles entidad)
        {
            ...
            try
            {
                ...
                AgregarHistorico(
                    accion: "Borrar",
                    registroId: entidad.Id,
                    descripcion: "Se borro un registro de BienesInmuebles",
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    accion: "Borrar",
                    registroId: entidad.Id,
                    descripcion: "Fallo al borrar un registro de BienesInmuebles",
