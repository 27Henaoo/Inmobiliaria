...
namespace LibInmobiliaria.Implementaciones.Catalogos
{
    ...
    {
        private string ObtenerDatosDepartamentos(Departamentos entidad)
        {
        ...
        public List<Departamentos> Consultar()
        {
            ...
            try
            {
                // Se consultan los registros de Departamentos en forma de lista.
                var lista = this.iConexion.Departamentos!.ToList();

                AgregarHistorico(
                    accion: "Consultar",
                    registroId: null,
                    descripcion: "Se consultaron los registros de Departamentos",
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    accion: "Consultar",
                    registroId: null,
                    descripcion: "Fallo al consultar los registros de Departamentos",
        ...
        public Departamentos Guardar(Departamentos entidad)
        {
            ...
            try
            {
                ...
                AgregarHistorico(
                    accion: "Guardar",
                    registroId: null,
                    descripcion: "Se guardo un nuevo registro de Departamentos",
                    cambios: "Se creo un nuevo registro",
                    valorAnterior: null,
                    valorNuevo: ObtenerDatosDepartamentos(entidad),
                    exitoso: true,
                    error: "N/A"
                );
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    ...
                    descripcion: "Fallo al guardar un registro de Departamentos",
        ...
        public Departamentos Modificar(Departamentos entidad)
        {
            ...
            try
            {
                ...
                var anterior = this.iConexion.Departamentos!.FirstOrDefault(x => x.Id == entidad.Id);

                if (anterior == null)
                    throw new Exception("El registro de Departamentos no existe");

                string valorAnterior = ObtenerDatosDepartamentos(anterior);
                string valorNuevo = ObtenerDatosDepartamentos(entidad);
                ...
                AgregarHistorico(
                    accion: "Modificar",
                    registroId: entidad.Id,
                    descripcion: "Se modifico un registro de Departamentos",
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    accion: "Modificar",
                    registroId: entidad.Id,
                    descripcion: "Fallo al modificar un registro de Departamentos",
        ...
        public Departamentos Borrar(Departamentos entidad)
        {
            ...
            try
            {
                ...
                AgregarHistorico(
                    accion: "Borrar",
                    registroId: entidad.Id,
                    descripcion: "Se borro un registro de Departamentos",
            ...
            catch (Exception ex)
            {
                AgregarHistorico(
                    accion: "Borrar",
                    registroId: entidad.Id,
                    descripcion: "Fallo al borrar un registro de Departamentos",
