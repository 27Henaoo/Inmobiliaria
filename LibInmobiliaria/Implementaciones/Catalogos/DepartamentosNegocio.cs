...
namespace LibInmobiliaria.Implementaciones.Catalogos
{
    public class DepartamentosNegocio : IDepartamentosNegocio
    {
        ...
        // Método para consultar todos los Departamentos.
        public List<Departamentos> Consultar()
        {
            ...
            // Se consultan todos los registros de Departamentos y se devuelven en forma de lista.
            return this.iConexion.Departamentos!.ToList();
        }
        ...
        public Departamentos Guardar(Departamentos entidad)
        {
            ...
            // Se agrega la entidad al conjunto de Departamentos.
            this.iConexion.Departamentos!.Add(entidad);
        ...
        public Departamentos Modificar(Departamentos entidad)
        {
            ...
            var entry = this.iConexion.Entry<Departamentos>(entidad);
        ...
        public Departamentos Borrar(Departamentos entidad)
        {
            ...
            this.iConexion.Departamentos!.Remove(entidad);
